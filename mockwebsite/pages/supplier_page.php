...
<!--    supplier_page.php    Team 1 Project supplier Table Page
    ...
    <div>
        ...
        <table class="tables" border=1>
            ...
            if (mysqli_num_rows($r3) > 0) {
                ...
                echo "Supplier Table Information:";
                echo "</p>";
                ...
                $q2 = "SELECT * FROM t1_suppliers $sort_type $direction";
                ...
                echo "<input type='radio' name='sort' value='name'> Company Name";
                echo "<input type='radio' name='sort' value='num_inventory_items'> Inventory";
                echo "<input type='radio' name='sort' value='contact_name'> Supplier Name";
                echo "<input type='radio' name='sort' value='contact_email'> Email";
                ...
                echo "<p class='admin_header'> <br> Click the button below to add supplier to the table. </p>";
                echo "<form action='add_supplier.php'>";
                echo "<input type='submit' value='Add Supplier '>";
                echo "</form>";
